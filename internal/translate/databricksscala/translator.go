...
var tmpl = template.Must(template.ParseFS(tmplFS, "databricksscala.go.tmpl"))

// Translator translates JSON schemas to Databricks Scala StructType definitions with metadata.
...
// Translate converts a JSON schema to Databricks Scala StructType definitions.
