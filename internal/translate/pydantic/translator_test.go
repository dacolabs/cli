...
func TestTranslate_SimpleObject(t *testing.T) {
	...
	assert.Contains(t, result, "class UsersSchema(BaseModel):")
	assert.Contains(t, result, "name: Optional[str] = None")
	assert.Contains(t, result, "age: Optional[int] = None")
	assert.NotContains(t, result, "@dataclasses.dataclass")
}
...
func TestTranslate_NestedObject(t *testing.T) {
	...
	assert.Contains(t, result, "class Address(BaseModel):")
...
func TestTranslate_TopologicalOrder(t *testing.T) {
	...
	addressIdx := strings.Index(result, "class Address(BaseModel):")
	customerIdx := strings.Index(result, "class Customer(BaseModel):")
...
func TestTranslate_NoDefs(t *testing.T) {
	...
	assert.Contains(t, result, "class SimpleSchema(BaseModel):")
...
func TestTranslate_ArrayOfObjects(t *testing.T) {
	...
	assert.Contains(t, result, "class Items(BaseModel):")
...
func TestTranslate_ChainedDeps(t *testing.T) {
	...
	aIdx := strings.Index(result, "class A(BaseModel):")
	bIdx := strings.Index(result, "class B(BaseModel):")
	cIdx := strings.Index(result, "class C(BaseModel):")
...
func TestTranslate_PydanticImport(t *testing.T) {
	schema := &jsonschema.Schema{
		Type: "object",
		Properties: map[string]*jsonschema.Schema{
			"x": {Type: "string"},
