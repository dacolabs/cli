...
Available formats: pyspark, pydantic, python, dqx-yaml, markdown, gotypes, spark-scala, databricks-scala, avro, databricks-pyspark, databricks-sql, protobuf, spark-sql, scala
...
```
  -a, --all             Translate all ports
      --format string   Output format (pyspark, pydantic, python, dqx-yaml, markdown, gotypes, spark-scala, databricks-scala, avro, databricks-pyspark, databricks-sql, protobuf, spark-sql, scala)
